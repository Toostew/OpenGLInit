...
Shader::Shader(const char* vertexPath, const char* fragmentPath) {
    ...
    // similiar for Fragment Shader, same shit
...
//the const you see at the end of the function is basically a promise that:
//"Callin this function will not change any of the member variables inside this class"
